<?php
    $url = file_get_contents('https://mangamint.kaedenoki.net/api/genres');
...
<body>
    ...
    <h1 class="text-center">Genre Manga</h1>

    <hr>

    <div class="row" id="manga-list">
        <div class="row justify-content-center">
            <?php foreach ($menu['list_genre'] as $data): ?>
            <div class="card">
                <div class="col-md-12">
                <center>
                  <div class="card-body">
                      <button type="button" class="btn btn-link"><a href="<?=$data['genre_name']?>" target="_blank" class="text-primary stretched-link"><?=$data['genre_name']?></a></button>
                  </div>
                </center>
                </div>
            </div>
