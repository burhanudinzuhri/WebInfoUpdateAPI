<?php
    $url = file_get_contents('https://api.jikan.moe/v3/manga/1/recommendations');
...
<head>
    ...
    <title>Recommendations Manga</title>
</head>
<body>
    ...
    <h1 class="text-center">Recommendations Manga</h1>

    <hr>

    <div class="row" id="manga-list">
        <div class="row justify-content-center">
            <?php foreach ($menu['recommendations'] as $data): ?>
            <div class="card">
                <div class="col-md-12">
                <center>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"> Jumlah Rekomendasi : <?=$data['recommendation_count']?></p>
