<?php
    $url = file_get_contents('https://api.jikan.moe/v3/top/manga/1/manga');
            ...
            <div class="card">
                ...
                <center>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"> Volume Total : <?=$data['volumes']?></p>
                        <p class="card-text"> Tanggal Mulai : <?=$data['start_date']?></p>
                        <p class="card-text"> Tanggal Selesai : <?=$data['end_date']?></p>
                        <p class="card-text"> Peringkat : <?=$data['rank']?></p>
