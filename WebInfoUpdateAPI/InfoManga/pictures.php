<?php
    $url = file_get_contents('https://api.jikan.moe/v3/manga/1/pictures');
...
<body>
    ...
    <h1 class="text-center">Manga Pictures</h1>

    <hr>

    <div class="row" id="manga-list">
        <div class="row justify-content-center">
            <?php foreach ($menu['pictures'] as $data): ?>
            <div class="card">
                <div class="col-md-12">
                <center>
                    <img src="<?=$data['large']?>" class="rounded" width="800" height="350" alt="">
                    <div class="card-body">
                        <button type="button" class="btn btn-link"><a href="<?=$data['large']?>" target="_blank" class="text-primary stretched-link"><?=$data['large']?></a></button>
                    </div>
                </center>
                </div>
            </div>
