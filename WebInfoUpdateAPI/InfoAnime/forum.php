<?php
    $url = file_get_contents('https://api.jikan.moe/v3/anime/1/forum');
...
<body>
    ...
    <div class="row" id="anime-list">
        <div class="row justify-content-center">
            <?php foreach ($menu['topics'] as $data): ?>
            <div class="card">
                <div class="col-md-12">
                <center>
                    <div class="card-body">
                        ...
                        <p class="card-text"> Tanggal Posting : <?=$data['date_posted']?></p>
                        <p class="card-text"> Tanggapan : <?=$data['replies']?></p>
