<?php
    $url = file_get_contents('https://api.jikan.moe/v3/anime/1/userupdates/1');
            ...
            <div class="card">
                ...
                <center>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"> Episode Ditonton : <?=$data['episodes_seen']?></p>
                        <p class="card-text"> Episode Total : <?=$data['episodes_total']?></p>
